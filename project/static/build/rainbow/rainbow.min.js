...
window.Rainbow = function () {
  function q(a) {
    ...
    if (b < a.length) {
      var d = a[b],
          f = B(d);return !(-1 < (" " + d.className + " ").indexOf(" rainbow ")) && f ? (f = f.toLowerCase(), d.className += d.className ? " rainbow" : "rainbow", n(d.innerHTML, f, function (k) {
    ...
    var a = a && "function" == typeof a.getElementsByTagName ? a : document,
      ...
      x = 0,
      l,
      p;return { extend: function (a, b, c) {
